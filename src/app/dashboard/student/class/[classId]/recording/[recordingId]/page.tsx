...
import { Play, ChevronLeft, Calendar, Copy, Check, Clock } from "lucide-react";
import type { User } from "@/lib/db";

export default function StudentRecordingViewer() {
  ...
  return (
    <div className="p-4 sm:p-8 max-w-5xl mx-auto flex flex-col gap-8 pb-20">
      ...
      <button 
        onClick={() => router.push(`/dashboard/student/class/${classId}`)}
